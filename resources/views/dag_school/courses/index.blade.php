    ...
    function getList(){
        if ($.fn.DataTable.isDataTable('#tbl_main')) {
            ...
            tbl_main = $('#tbl_main').DataTable( {
                ...
                ajax: {
                    type: 'GET',
                    url: "{{ url('dag_school/program-courses/list') }}",
                    data: {
                ...
                columnDefs: [
                    ...
                    {   targets: 'col_action',
                        ...
                        className: 'dt-center',
                         render: function (data, type, row, meta) {
                          var tmp = '<a name="" href="{{ url('dag_school/program-courses/edit') }}/'+row.id+'" class="btn btn-primary btn-mini rounded" data-ref_id="'+row.id+'" href="#" ><i class="fa fa-edit"></i> แก้ไข</a>';
                            return tmp;
                         }
                     }
                ]
