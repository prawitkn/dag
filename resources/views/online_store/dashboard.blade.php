...
<section>
  <div class="container-fluid">
    <div class="row" id="divFlashAlert">

    </div>
    <!-- Page Header-->
    <header> 
      <h1 class="display">รายการสั่งสินค้า
        &nbsp;<a href="#" class="btn btn-danger shadow rounded" name="btn_end"  /> ปิดเวลาการสั่งสินค้า</a>     
      &nbsp;<a target="_blnak" href="" class="btn btn-primary shadow rounded" name="btn_export"  /> นำออกข้อมูล Excel</a>     
      </h1>
...
<!--         <div class="form-group col-md-3">          
      ...
      <!--/.row-->
    <!-- Table -->
      <div name="div_main" class="table-responsive">
        <table id="tbl_main" class="dataTable compact row-border hover" style="width: 100%" > 
            <thead>
                <tr>
                    ...
                    <th class="col_updated" style="text-align: center;">สั่งข้อมูล สาขา</th>
                    <th class="col_total" style="text-align: center;">ทั้งหมด สาขา</th>
...
$(document).ready(function(){
  ...
  var tbl_main; 
    function getMainList(){  
      ...
      $('div[name="div_main"]').hide().fadeIn('slow');  
  } //.getMainList()
