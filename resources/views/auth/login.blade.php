        ...
        <div class="col-md-5 col-lg-6 col-xl-4 px-lg-5 d-flex align-items-center">
          <div class="w-100 py-5">			
			...
			<!-- 	@if (Route::has('password.request'))
                ...
                @endif -->
              <!-- Link-->
             <!--  <p class="text-center"><small class="text-muted text-center">Don't have an account yet? <a href="{{ url('/register') }}">Register</a>.</small></p> -->
            </form>
          </div>
        </div>
        <div class="col-12 col-md-7 col-lg-6 col-xl-8 d-none d-lg-block">
          <!-- Image-->
          <div style="background-image: url(public/assets/images/background/ds.jpg);" class="bg-cover h-100 mr-n3"></div>
        </div>
      </div>
    </div>
    <!-- JavaScript files-->
