...
@yield('head')
	...
	/*Customer From*/
	/* blue 2b90d9 */
	label.label-material-select { font-size: 0.8rem; top: -10px; position: absolute; 
		/* color: #2b90d9; Blue */
		color: #33b35a; //Green
	}
	select.select-material { width: 100%; position: absolute; top: 5px; }
	textarea.textarea-material { width: 100%; position: absolute; top: 5px; border-top: none; border-left: none; border-right: none; border-bottom: 1px solid #eee; }
