...
@section('content')
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Copy Product</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="card">
                <form id="form1" class="" enctype="multipart/form-data" method="post" action="{{ url('/prodlib/copy-product/'.$product->id) }}" >{{ csrf_field() }}
